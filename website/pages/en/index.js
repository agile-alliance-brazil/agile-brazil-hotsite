      ...
      id="sponsorship" style={{textAlign: 'center'}}> 
        ...
        <div className="showcase">
          ...
          <a className="link" href="https://www.easynvest.com.br/">
            <img src={`${siteConfig.baseUrl}img/sponsors/easynvest-white.png`}
            alt="Easynvest">
            </img>
          </a>
        </div>
    ...
    const Supporters = () => (
      ...
      id="supporters" style={{textAlign: 'center'}}> 
        ...
        <div className="showcase">
          ...
          <a className="link" href="https://www.meetup.com/GrupoLeanCoffeeBH/">
            <img src={`${siteConfig.baseUrl}img/supporters/leancoffeebh.jpeg`}
            alt="Lean Coffee BH" width="130" height="130">
            </img>
          </a>
